package com.michel.transito.api.exceptionhandler;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        problemDetail.setType(URI.create("https//transito.com.br"));
    ...
    public ProblemDetail handleNegocio (NegocioException e) {
       ...
       problemDetail.setType(URI.create("https//transito.com.br/nao-encontrado"));
    ...
    public ProblemDetail handleEntidadeNaoEncontrada (NegocioException e) {
        ...
        problemDetail.setTitle(e.getMessage());
        problemDetail.setType(URI.create("https//transito.com.br/regra-de-negocio"));
        return problemDetail;
    }
    ...
    public ProblemDetail HandleDataIntegrity(DataIntegrityViolationException e) {
        ...
        problemDetail.setType(URI.create("https//transito.com.br/recurso-em-uso"));
